...
enum School {POSTECH, KAIST, UNIST, GIST};
enum GameType {SWIMMING, SOCCER, BASKETBALL, QUIZ};
enum CharacterType {STUDENT, POBBA, KAISER, SWIMMER, PHYSICS, DEPTTOP};
enum SavePoint {NEW, SINGLESELECT, OLYMPICSELECT};
